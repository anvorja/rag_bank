...
#     RETRIEVER_FETCH_K: int = Field(default=20, ge=10, le=100, description="Number of documents to fetch before MMR")
#     LAMBDA_MULT: float = Field(default=0.7, ge=0.0, le=1.0, description="MMR lambda parameter for diversity")
#
#     # === CHUNKING CONFIG ===
...
#
#     # === API KEYS ===
#     OPENAI_API_KEY: Optional[str] = Field(default=None, description="OpenAI API key for cloud mode")
#
#     # === LOGGING ===
#     LOG_LEVEL: str = "INFO"
#
...
#             return None
#
#         # La validación de modo cloud se hace en otro validador
#         return v
#
#     @field_validator("CHUNK_OVERLAP")
#     @classmethod
...
#     @field_validator("OPENAI_API_KEY")
#     @classmethod
#     def check_openai_key_required(cls, v: Optional[str], info) -> Optional[str]:
#         """Check if OpenAI API key is required for cloud mode"""
#         mode = info.data.get("MODE")
#         if mode == "cloud" and not v:
#             raise ValueError("OPENAI_API_KEY required when MODE=cloud")
#         return v

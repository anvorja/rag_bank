...
#         return "\n\n---\n\n".join(formatted_docs)
#
#     def _format_conversation_history(self, history: List[MessageHistory]) -> str:
...
#
#     def _add_contextual_greeting(self, answer: str) -> str:
...
#         return sources
#
#     def _calculate_confidence(self, docs, question: str) -> float:
